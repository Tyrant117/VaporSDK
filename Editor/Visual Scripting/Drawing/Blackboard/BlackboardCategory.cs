...
//{
//    public class BlackboardCategory : GraphElement, IUIControlledElement<BlackboardCategoryController>, ISelection, IComparable<BlackboardCategory>
//    {
//        // --- Begin IUIControlledElement implementation
...
//        int m_InsertIndex;
//        Blackboard blackboard => m_ViewModel.parentView as Blackboard;
...
//            var blackboardRows = this.Query<BlackboardRow>().ToList();
...
//        static VisualElement FindCategoryDirectChild(BlackboardCategory blackboardCategory, VisualElement element)
//        {
...
//        public BlackboardCategory(BlackboardCategoryViewModel categoryViewModel, BlackboardCategoryController inController)
//        {
...
//                    isExpandedAction.CategoryGuids = selection.OfType<BlackboardCategory>().Select(s => s.viewModel.associatedCategoryGuid).ToList();
//                else
...
//            var key = $"{blackboard.controller.editorPrefsBaseKey}.{viewDataKey}.{ChangeCategoryIsExpandedAction.s_KEditorPrefKey}";
...
//                var fieldViews = this.Query<BlackboardField>();
...
//            if (selection.OfType<BlackboardField>().Any() == false)
//            {
//                SetDragIndicatorVisible(false);
//                return;
//            }
...
//            SortedDictionary<BlackboardCategory, List<VisualElement>> draggedElements = new SortedDictionary<BlackboardCategory, List<VisualElement>>();
...
//                else
//                {
//                    var otherCategory = draggedElement.GetFirstAncestorOfType<BlackboardCategory>();
...
//                {
//                    var blackboardField = draggedElement.Q<BlackboardField>();
...
//            var materialGraphView = m_ViewModel.parentView.GetFirstAncestorOfType<BlueprintGraphView>();
...
//        {
//            var materialGraphView = blackboard.ParentView as BlueprintGraphView;
...
//        public int CompareTo(BlackboardCategory other)
//        {
//            if (other == null)
//                return 1;
