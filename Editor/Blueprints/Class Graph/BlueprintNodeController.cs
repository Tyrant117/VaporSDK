...
namespace Vapor.Blueprints
{
    ...
    //
    //                 foreach (var parameter in Graph.Arguments)
    //                 {
    //                     if (parameter.IsReturn || parameter.IsOut)
    //                     {
    //                         continue;
    //                     }
    //                     
    //                     var slot = new BlueprintPin(this, parameter.DisplayName, PinDirection.Out, parameter.Type, false)
    //                         .WithAllowMultipleWires();
    //                     OutPorts.Add(parameter.DisplayName, slot);
    //                 }
    //                 break;
    //             }
    ...
    //                         {
    //                             var ownerPin = new BlueprintPin(this, PinNames.OWNER, PinDirection.In, model.FieldInfo.DeclaringType, true);
    //                             InPorts.Add(PinNames.OWNER, ownerPin);
    //                         }
    //
    //                         // Out Pin
    //                         var returnPin = new BlueprintPin(this, PinNames.GET_OUT, PinDirection.Out, model.FieldInfo.FieldType, false)
    //                             .WithAllowMultipleWires();
    ...
    //
    //                         // Set Pin
    //                         var setterPin = new BlueprintPin(this, PinNames.SET_IN, PinDirection.In, model.FieldInfo.FieldType, false);
    ...
    //                     }
    //
    //                     var slot = new BlueprintPin(this, parameter.DisplayName, PinDirection.In, parameter.Type, false);
    //                     InPorts.Add(parameter.DisplayName, slot);
    //                 }
    //                 break;
    //             }
    ...
    //
    //                 var slot = new BlueprintPin(this, PinNames.SET_IN, PinDirection.In, data.Item1, false)
    //                     .WithDisplayName(string.Empty);
    //                 InPorts.Add(PinNames.SET_IN, slot);
    //
    //                 var outSlot = new BlueprintPin(this, PinNames.GET_OUT, PinDirection.Out, data.Item2, false)
    //                     .WithDisplayName(string.Empty)
    //                     .WithAllowMultipleWires();
    ...
    //                 {
    //                     var slot = new BlueprintPin(this, PinNames.SET_IN, PinDirection.In, rerouteType, false)
    //                         .WithDisplayName(string.Empty);
    //                     InPorts.Add(PinNames.SET_IN, slot);
    //
    //                     var outSlot = new BlueprintPin(this, PinNames.GET_OUT, PinDirection.Out, rerouteType, false)
    //                         .WithDisplayName(string.Empty)
    //                         .WithAllowMultipleWires();
    //                     OutPorts.Add(PinNames.GET_OUT, outSlot);
    //                 }
    ...
    //
    //                 var inData = new BlueprintPin(this, PinNames.IGNORE, PinDirection.In, makeType, false)
    //                     .WithDisplayName(string.Empty);
    //                 InPorts.Add(PinNames.IGNORE, inData);
    //
    //                 var os = new BlueprintPin(this, PinNames.RETURN, PinDirection.Out, makeType, false)
    //                     .WithDisplayName(string.Empty)
    //                     .WithAllowMultipleWires();
