...
{
    [SearchableNode("Math/Basic/Power", "Power")]
    public class PowerNodeSo : MathNodeSo
    {
        ...
        public override float Evaluate(IExternalValueGetter externalValues, int portIndex)
        {
            ...
            return Mathf.Pow(_a.Evaluate(externalValues, ConnectedPort_A), _b.Evaluate(externalValues, ConnectedPort_B));
        }
    }
}
