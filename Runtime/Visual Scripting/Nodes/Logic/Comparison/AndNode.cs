...
{
    public class AndNode : IReturnNode<bool>
    {
        public uint Id { get; }
        ...
        public AndNode(string guid, NodePortTuple a, NodePortTuple b)
        {
    ...
    [Serializable, SearchableNode("Logic/And", "And", "logic")]
    public class AndNodeData : NodeModel
    {
