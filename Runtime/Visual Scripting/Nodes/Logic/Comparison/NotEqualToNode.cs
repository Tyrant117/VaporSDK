...
{
    public class NotEqualToNode : IReturnNode<bool>
    {
        public uint Id { get; }
        ...
        public NotEqualToNode(string guid, NodePortTuple a, NodePortTuple b)
        {
    ...
    [Serializable, SearchableNode("Logic/NotEqual", "NotEqual", "logic")]
    public class NotEqualToNodeData : NodeModel
    {
        ...
        public override INode Build(GraphModel graph)
        {
            ...
            NodeRef = new NotEqualToNode(Guid, a, b);
            return NodeRef;
        }
