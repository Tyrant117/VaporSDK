...
{
    public class LessThanOrEqualNode : IReturnNode<bool>
    {
        public uint Id { get; }
        ...
        public LessThanOrEqualNode(string guid, NodePortTuple a, NodePortTuple b)
        {
    ...
    [Serializable, SearchableNode("Logic/LessThanOrEqual", "LessThanOrEqual", "logic")]
    public class LessThanOrEqualNodeData : NodeModel
    {
        ...
        public override INode Build(GraphModel graph)
        {
            ...
            NodeRef = new LessThanOrEqualNode(Guid, a, b);
            return NodeRef;
        }
