...
{
    public class GreaterThanNode : IReturnNode<bool>
    {
        public uint Id { get; }
        ...
        public GreaterThanNode(string guid, NodePortTuple a, NodePortTuple b)
        {
    ...
    [Serializable, SearchableNode("Logic/GreaterThan", "GreaterThan", "logic")]
    public class GreaterThanNodeData : NodeModel
    {
        ...
        public override INode Build(GraphModel graph)
        {
            ...
            NodeRef = new GreaterThanNode(Guid, a, b);
            return NodeRef;
        }
