...
{
    public class LessThanNode : IReturnNode<bool>
    {
        public uint Id { get; }
        ...
        public LessThanNode(string guid, NodePortTuple a, NodePortTuple b)
        {
    ...
    [Serializable, SearchableNode("Logic/LessThan", "LessThan", "logic")]
    public class LessThanNodeData : NodeModel
    {
        ...
        public override INode Build(GraphModel graph)
        {
            ...
            NodeRef = new LessThanNode(Guid, a, b);
            return NodeRef;
        }
